...
llama_kv_cache_iswa::llama_kv_cache_iswa(
    ...
    const  layer_reuse_cb & reuse,
                     bool   use_turboquant) : hparams(model.hparams), unified(unified) {
    ...
    kv_base = std::make_unique<llama_kv_cache>(
            ...
            0, LLAMA_SWA_TYPE_NONE, filter_base, reuse, use_turboquant);
    ...
    kv_swa = std::make_unique<llama_kv_cache>(
            ...
            hparams.n_swa, hparams.swa_type, filter_swa, reuse, use_turboquant);
}
