...
llama_context::llama_context(
    ...
    if (!hparams.vocab_only) {
        llama_memory_params params_mem = {
            ...
            /*.use_turboquant =*/ params.use_turboquant,
        };
...
llm_graph_params llama_context::graph_params(
    ...
    // Create H2O accumulator for attention score tracking
    turboquant::H2OAttentionAccumulator* h2o_acc = nullptr;
    if (mctx) {
        // Try to get KV cache context from memory context
        // For now, we create a null accumulator - the actual accumulator management
        // happens at the KV cache layer level
        h2o_acc = nullptr;
    }
